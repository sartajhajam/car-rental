...
const Banners = ({ img, title, text, backgroundColor = "#f5f5f5" }) => {
  return (
    <div className="">
      ...
      >
        <div className="content-[''] absolute top-0 right-0 bottom-0 left-0 bg-[rgba(0,0,0,0.2)] opacity-40"></div>

        <div className="w-full lg:w-[70%] text-white">
          <h1 className="text-2xl lg:text-7xl font-medium text-cyan-400 mb-2 lg:mb-5">
            {title}
          </h1>
