      ...
      <div className="flex flex-col justify-center gap-8 md:px-16 px-8 md:my-0 my-8">
        <div className="flex items-center gap-5">
          <span className="shadow-xl text-2xl p-6 rounded-full">
            <MdCardTravel className="text-cyan-400" />
          </span>
          <div className="flex flex-col gap-2">
            <h5 className="text-2xl text-gray-900 font-bold">Wedding</h5>
            <p className="mb-4 text-base text-gray-500 border-l-4 border-b-cyan-400 pl-4">
        ...
        <div className="flex items-center gap-5">
          <span className="shadow-xl text-2xl p-6 rounded-full">
            <IoCarSport className="text-cyan-400" />
          </span>
          <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-5">
          <span className="shadow-xl text-2xl p-6 rounded-full">
            <IoMdContacts className="text-cyan-400" />
          </span>
          <div className="flex flex-col gap-2">
